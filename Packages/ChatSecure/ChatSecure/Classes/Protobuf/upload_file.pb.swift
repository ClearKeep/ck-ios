...
struct UploadFile_GetUploadFileLinkRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct UploadFile_GetUploadFileLinkResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var uploadedFileURL: String = String()

  var downloadFileURL: String = String()

  var objectFilePath: String = String()
...
struct UploadFile_GetDownloadFileLinkRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct UploadFile_GetDownloadFileLinkResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension UploadFile_GetUploadFileLinkRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetUploadFileLinkRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: UploadFile_GetUploadFileLinkRequest, rhs: UploadFile_GetUploadFileLinkRequest) -> Bool {
...
extension UploadFile_GetUploadFileLinkResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetUploadFileLinkResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: UploadFile_GetUploadFileLinkResponse, rhs: UploadFile_GetUploadFileLinkResponse) -> Bool {
...
extension UploadFile_GetDownloadFileLinkRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetDownloadFileLinkRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: UploadFile_GetDownloadFileLinkRequest, rhs: UploadFile_GetDownloadFileLinkRequest) -> Bool {
    if lhs.objectFilePath != rhs.objectFilePath {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension UploadFile_GetDownloadFileLinkResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetDownloadFileLinkResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: UploadFile_GetDownloadFileLinkResponse, rhs: UploadFile_GetDownloadFileLinkResponse) -> Bool {
    if lhs.downloadFileURL != rhs.downloadFileURL {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
