...
public struct PasscodeTextField: View {
    ...
    var body: some View {
		TextField("", text: $text)
			...
			.frame(width: Constants.widthPasscode, height: Constants.widthPasscode)
...
struct PasscodeTextField_Previews: PreviewProvider {
    static var previews: some View {
		PasscodeTextField(text: .constant("Test"), inputStyle: .constant(.error(message: "Error"))) { _ in
