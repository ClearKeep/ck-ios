...
public protocol ICommonUIImageSet: IImageSet {
	...
	var homeIcon: UIImage { get }
	var plusIcon: UIImage { get }
	var noteIcon: UIImage { get }
	var gearIcon: UIImage { get }
	var logoutIcon: UIImage { get }
	var chevUpIcon: UIImage { get }
	var chevRightIcon: UIImage { get }
	...
	var messagePlusIcon: UIImage { get }
	var phoneIncommingIcon: UIImage { get }
	var phoneOffIcon: UIImage { get }
	...
	var userCheckIcon: UIImage { get }
	var eyeIcon: UIImage { get }
	var eyeCrossIcon: UIImage { get }
	var faceIcon: UIImage { get }
	var photoIcon: UIImage { get }
	var atIcon: UIImage { get }
	var archireIcon: UIImage { get }
	var shareIcon: UIImage { get }
	var bellIcon: UIImage { get }
	var searchIcon: UIImage { get }
	var alertIcon: UIImage { get }
	var copyIcon: UIImage { get }
	var quoteIcon: UIImage { get }
	...
	var facebookIcon: UIImage { get }
	var officeIcon: UIImage { get }
}
