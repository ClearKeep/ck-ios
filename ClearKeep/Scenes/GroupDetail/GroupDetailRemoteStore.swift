...
protocol IGroupDetailRemoteStore {
	...
	func addMember(_ user: GroupDetailUserViewModels, groupId: Int64, domain: String, clientId: String, displayName: String) async -> (Result<IGroupDetailModels, Error>)
...
extension GroupDetailRemoteStore: IGroupDetailRemoteStore {
	...
	func addMember(_ user: GroupDetailUserViewModels, groupId: Int64, domain: String, clientId: String, displayName: String) async -> (Result<IGroupDetailModels, Error>) {
		...
		let result = await groupService.addMember(client, groupId: groupId, domain: domain, clientId: clientId, displayName: displayName)
